...
//urlConnection.connect();
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String follows=jsonObj.getJSONObject("data").getJSONObject("counts").getString("follows");
                    String followed_by=jsonObj.getJSONObject("data").getJSONObject("counts").getString("followed_by");
                    String media=jsonObj.getJSONObject("data").getJSONObject("counts").getString("media");

                    userInfo.put(InstagramAppTags.TAG_USERNAME.toString(),name);
                    userInfo.put(InstagramAppTags.TAG_PROFILE_PICTURE.toString(),profile_picture);
                    userInfo.put(InstagramAppTags.TAG_FOLLOWS.toString(), follows);
                    userInfo.put(InstagramAppTags.TAG_FOLLOWED_BY.toString(),followed_by);
                    userInfo.put(InstagramAppTags.TAG_MEDIA.toString(),media);
    ...
    public void fetchUserMedia() {
        mProgress.setMessage("Finalizing ...");
        new Thread() {
            @Override
            public void run() {
                Log.i(TAG, "Fetching user meia");
                int what = WHAT_FINALIZE;
                try {
